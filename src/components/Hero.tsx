  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Ты справишься.
          <span className="block text-sage">Дыши и действуй.</span>
        </h1>
        ...
        >
          Конкретные техники управления стрессом перед экзаменами — за месяц, за неделю, за день и прямо в аудитории. Понятно, без лишних слов.
        </p>
